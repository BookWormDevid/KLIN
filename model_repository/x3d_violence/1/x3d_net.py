...
class ResNet(nn.Module):
    def __init__(
        ...
        self.bn5 = SubBatchNorm3d(
            ...
            affine=True,
        )  # nn.BatchNorm3d(block_inplanes[3][0])
        if task == "class":
    ...
    #             m.split_bn = nn.BatchNorm3d(num_features=m.num_features*m.num_splits,
    # affine=False).to(m.weight.device)
